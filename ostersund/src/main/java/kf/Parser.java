...
public class Parser {
    ...
    public ArrayList<Invoice> toInvoices(ArrayList<InvoiceItem> invoiceItems, ArrayList<InvoiceItem> discountList,
            int validTime) throws IllegalArgumentException {
        {
